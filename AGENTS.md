...
# Startup Zone Codex Instructions
...
Codex has broad autonomy within the active task and may, without additional confirmation:
...
2. Create a branch from the intended base using `codex/<short-task-name>` unless the user supplies another name.
