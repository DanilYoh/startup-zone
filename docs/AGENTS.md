...
[`architecture.md`](architecture.md). Read and follow that document
...
- Never work directly on `main`. Use a descriptive `<short-task-name>` branch unless the user specifies another branch.
