    ...
    <Stack gap="xl">
      ...
      <section>
        ...
        <Text mt="sm">
          ...
          блокирование или удаление данных и отозвать согласие письмом на{" "}
          <Anchor href={`mailto:${config.operatorEmail}`}>{config.operatorEmail}</Anchor>. Оператор
          отвечает в сроки и порядке, установленные законодательством Российской Федерации.
        </Text>
      </section>
    ...
    <Stack gap="xl">
      ...
      <section>
        ...
        <Text mt="sm">
          ...
          электронной почты, выбранной роли, сведений профиля, профессиональных ссылок, приватных
          контактов, опубликованных данных стартапа и сообщений в инвестиционных заявках. Цели:
          создание и защита учётной записи, предоставление функций маркетплейса, проверка прав
          доступа, связь между сторонами принятой заявки и поддержка пользователей.
        </Text>
      </section>
      ...
      <section>
        ...
        <Text mt="sm">
          ...
          продолжение обработки по иному основанию. Отозвать согласие можно письмом на{" "}
